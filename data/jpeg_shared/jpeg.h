...
#define SwapEndian(num) 	(((num >> 24) & 0x000000FF) | \
							(( num << 8)  & 0x00FF0000) | \
							(( num >> 8)  & 0x0000FF00) | \
							(( num << 24) & 0xFF000000))
...
extern volatile unsigned int *ColorBuffer;
...
// Used for initial simple test //extern unsigned int input_buffer[201];
...
//void paint ();
extern DMA dma;
extern volatile unsigned int *input_buffer ;
